	...
	$.fn.TMSlider=$.fn.TMS=$.fn._TMS=function(o){
		return this.each(function(){
			var th=$(this),				
									...
									setTimeout(function(){
										_.pic
											.css({
												...
												background:_.preset=='zoomer'?'none':('url('+_.itms[_.show]+') center 0 no-repeat')
											})
										img.remove()
                ...
                $('.'+_.bannerCl).wrap('<div class="bannerContainer">')
							_.afterAnimation()
							_.bl=false
						},
						bannerShow:function(){},
...
// Au lancement de l'appli, on wrappe le premier 'banner' avec le bannerContainer
$(function() {
  $('.banner').wrap('<div class="bannerContainer">');
});